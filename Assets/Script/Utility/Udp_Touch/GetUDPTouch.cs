...
public class GetUDPTouch : MonoBehaviour
{

    [Tooltip("消息处理类")] public DealWithPad_TouchMessage m_messageManage;
    public int m_ReceivePort = 29011;
    ...
    public IEnumerator InitializationUdp()
    {
        //得到本机IP，设置TCP端口号        
        Debug.Log("打开端口接收按钮" + m_ReceivePort);
